...
interface DetalleModalsOrchestratorProps {
  ...
  handleClosingConfirm: (precioCierre: number | null, montoReserva: number | null, cerradoConId: string, agenteCerradorId: string | undefined, finalStatus: string) => Promise<void>;
