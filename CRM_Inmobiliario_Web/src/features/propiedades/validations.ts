...
export const propertySchema = z.object({
  ...
  descripcion: z.string().min(20, 'Debe proporcionar una descripción detallada (mín. 20 caracteres)').max(1000, 'Máximo 1000 caracteres'),
  ...
  banos: z.coerce.number().min(0).multipleOf(0.1, 'Máximo 1 decimal'),
