...
import { TIPO_NOTA_OPCIONES, formatDate } from '../../constants/clientes';
import type { Interaccion } from '../../types';

interface ClienteTimelineManagerProps {
  nuevaNota: string;
...
export const ClienteTimelineManager = ({
  nuevaNota,
  setNuevaNota,
  tipoNota,
  setTipoNota,
