...
interface ClientePropertiesOwnedProps {
  cliente: Cliente;
  onNavigate: (id: string) => void;
}

export const ClientePropertiesOwned = ({ cliente, onNavigate }: ClientePropertiesOwnedProps) => {
  const propiedades = cliente.propiedadesCaptadas || [];
