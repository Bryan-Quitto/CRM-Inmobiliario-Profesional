...
interface ContactosListStatsProps {
  total: number;
  nuevos: number;
  negociacion: number;
}

export const ContactosListStats = ({ total, nuevos, negociacion }: ContactosListStatsProps) => (
  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
    <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm flex items-center gap-4 group hover:border-blue-100 transition-all cursor-default">
      ...
      <div>
        <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Total Contactos</p>
