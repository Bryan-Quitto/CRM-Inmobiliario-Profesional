...
**Ziel Luxora CRM acts exclusively as the Data Processor**, limiting itself to providing the technological infrastructure for the storage and processing of such data under the Agent's instructions.
...
The platform allows linking with Meta channels. The User agrees to fully comply with Meta's Commerce and Messaging Policies. Misuse, sending spam, or account blockage by Meta is the exclusive responsibility of the Agent. Ziel Luxora CRM does not guarantee the uninterrupted availability of these integrations, as they depend on the policies of Meta's interface.
...
*   Not attempt to bypass, reverse engineer, or overload Ziel Luxora CRM's security and infrastructure (including its databases on Supabase and its cloud services).
