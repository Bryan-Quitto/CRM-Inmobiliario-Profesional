...
const PageSelectorModal: React.FC<PageSelectorProps> = ({
  ...
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
    <div className="bg-white rounded-3xl shadow-2xl border border-slate-200 w-full max-w-md mx-4 animate-in zoom-in-95 duration-200 max-h-[95vh] md:max-h-[90vh] flex flex-col">
