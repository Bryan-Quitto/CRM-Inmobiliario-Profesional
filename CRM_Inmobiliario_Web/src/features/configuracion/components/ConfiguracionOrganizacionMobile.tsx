...
export const ConfiguracionOrganizacionMobile: React.FC<Props> = () => {
  return (
    <div className="space-y-6 w-full">
      <section className="space-y-6 bg-slate-100/50 p-4 rounded-3xl border border-slate-200/60 animate-in fade-in slide-in-from-top-4 duration-1000 w-full">
        <div className="flex items-center gap-3 mb-4 w-full">
          <div className="p-2 bg-emerald-100 text-emerald-600 rounded-lg shrink-0">
            <UserPlus size={20} />
          </div>
          <h2 className="text-xl font-black text-slate-800 tracking-tight flex-1 min-w-0 break-words">Gestión de Equipo</h2>
        </div>
