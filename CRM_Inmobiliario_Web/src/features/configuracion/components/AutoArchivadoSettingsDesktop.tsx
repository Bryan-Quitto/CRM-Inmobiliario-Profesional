          ...
          <form onSubmit={(e) => {
            ...
            <div className="pt-4 border-t border-slate-100 flex justify-end">
              <button
                ...
                className={`px-6 py-2.5 bg-indigo-600 text-white font-semibold rounded-xl hover:bg-indigo-700 focus:ring-4 focus:ring-indigo-100 transition-all flex items-center gap-2 disabled:opacity-50 ${!canWrite ? 'cursor-not-allowed' : 'cursor-pointer'}`}
              >
                {isSaving ? (
