...
import { Building2, Plus, Loader2, Check, UserPlus } from 'lucide-react';
        ...
        <div className="max-w-xl">
          ...
          <form onSubmit={handleCrearAgencia} className="flex gap-2">
            ...
            <button
              ...
              className={`cursor-pointer px-6 py-3 rounded-xl font-bold flex items-center gap-2 transition-all duration-300 shadow-sm disabled:cursor-not-allowed
                ${agenciaCreada 
