      ...
      <div className={`w-full flex flex-col space-y-1.5 ${containerClassName}`}>
        ...
        <div className="relative">
          ...
          <textarea
            ...
            maxLength={maxLength}
            className={`w-full px-3.5 py-2.5 bg-white border rounded-xl text-sm font-medium outline-none transition-all shadow-sm resize-none disabled:opacity-50 disabled:bg-slate-50
            ...
            {...props}
          />
          <div className="absolute right-3 bottom-2 flex items-center justify-end pointer-events-none">
