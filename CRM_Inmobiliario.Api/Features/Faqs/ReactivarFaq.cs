...
public static class ReactivarFaqFeature
{
    public static void MapReactivarFaqEndpoint(this IEndpointRouteBuilder app)
    {
        app.MapPost("/faqs/{faqId:guid}/reactivar", async (
            Guid faqId,
            ...
            CrmDbContext context) =>
        {
            ...
            if (faq.Estado != "Desactivada")
                return Results.Conflict($"Solo se puede reactivar un FAQ en estado Desactivada. Estado actual: '{faq.Estado}'.");
