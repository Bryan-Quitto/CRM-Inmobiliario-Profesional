...
public sealed class WhatsAppToolExecutor : IWhatsAppToolExecutor
{
    ...
    public async Task<string> HandleToolCallAsync(ChatToolCall toolCall, string customerPhone, string triggerMessage, Contacto? currentContacto, string phoneNumberId)
    {
