...
namespace CRM_Inmobiliario.Api.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260720161904_AddConsentimientoIA")]
    partial class AddConsentimientoIA
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CRM_Inmobiliario.Api.Domain.Entities.Agent", b =>
                {
                    ...
                    b.Property<bool>("AutoArchivarContactos")
                        .HasColumnType("boolean");

                    b.Property<bool>("AutoArchivarPropiedades")
                        .HasColumnType("boolean");
                    ...
                    b.Property<int>("DiasInactividadContactos")
                        .HasColumnType("integer");

                    b.Property<int>("DiasInactividadPropiedades")
                        .HasColumnType("integer");
                    ...
                    b.Property<long>("GlobalStorageBytesLimit")
                        .HasColumnType("bigint");

                    b.Property<long>("GlobalStorageBytesUsed")
                        .HasColumnType("bigint");
                    ...
                    b.Property<int>("NotifyAiHelpTasksIntervalMinutes")
                        .HasColumnType("integer");

                    b.Property<int>("NotifyAiHelpTasksMaxRetries")
                        .HasColumnType("integer");

                    b.Property<int>("NotifyOverdueTasksIntervalMinutes")
                        .HasColumnType("integer");

                    b.Property<int>("NotifyOverdueTasksMaxHours")
                        .HasColumnType("integer");

                    b.Property<int>("NotifyTodayTasksAdvanceMinutes")
                        .HasColumnType("integer");

                    b.Property<int>("NotifyTodayTasksIntervalMinutes")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CRM_Inmobiliario.Api.Domain.Entities.AgentArchivedContact", b =>
                {
                    ...
                    b.ToTable("AgentArchivedContacts");
                });

            modelBuilder.Entity("CRM_Inmobiliario.Api.Domain.Entities.AgentArchivedProperty", b =>
                {
                    b.Property<Guid>("AgentId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CRM_Inmobiliario.Api.Domain.Entities.AgentStorageFileLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AgentStorageFileLogs");
                });

            modelBuilder.Entity("CRM_Inmobiliario.Api.Domain.Entities.AgentStorageUsage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CRM_Inmobiliario.Api.Domain.Entities.AiActionLog", b =>
                {
                    ...
                    b.HasIndex("Canal", "TelefonoContacto", "Fecha")
            ...
            modelBuilder.Entity("CRM_Inmobiliario.Api.Domain.Entities.Contacto", b =>
                {
                    ...
                    b.Property<string>("ConsentimientoIA_FB")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");

                    b.Property<string>("ConsentimientoIA_WA")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");
                    ...
                    b.Property<string>("EstadoEmbudo")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
                    ...
                    b.HasIndex("AgenteId", "EstadoEmbudo", "FechaCierre", "FechaCreacion")
            ...
            modelBuilder.Entity("CRM_Inmobiliario.Api.Domain.Entities.FacebookMessage", b =>
                {
                    ...
                    b.Property<string>("OrigenMensaje")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("CRM_Inmobiliario.Api.Domain.Entities.PendingStorageDeletion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("PendingStorageDeletions");
                });
            ...
            modelBuilder.Entity("CRM_Inmobiliario.Api.Domain.Entities.Property", b =>
                {
                    ...
                    b.Property<bool?>("BloqueoAdministrativo")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("CRM_Inmobiliario.Api.Domain.Entities.PushNotificationsOutbox", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("PushNotificationsOutbox");
                });
            ...
            modelBuilder.Entity("CRM_Inmobiliario.Api.Domain.Entities.TaskItem", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("UltimaNotificacionEnviada")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("CRM_Inmobiliario.Api.Features.Shared.OmniSearch.OmniSearchResult", b =>
                {
                    ...
                    b.Property<Guid>("VisibleToAgenteId")
                        .HasColumnType("uuid");

                    b.ToTable((string)null);

                    b.ToView("vw_omni_search", (string)null);
                });
